...
export class ConsultaComponent implements OnInit {
  ...
  estadoBotonRegistrar() {
    return this.idMedicoSeleccionado !== 0 && this.idPacienteSeleccionado !== 0 && this.idEspecialidadSeleccionado && this.detalleConsulta.length !== 0 ? false : true;
  }
  ...
  aceptar(){
    ...
    let paciente = new Paciente(this.idPacienteSeleccionado, '', '', '', '', '', '', 0, null);
    ...
    this.consultaService.registrarTransaccion(consultaListaExamenDTO).subscribe( ()=> {
      this.snackBar.open("La cita fue registrada", "Aviso", { duration: 2000 });
