...
export class ConsultaEspecialComponent implements OnInit {
  ...
  estadoBotonRegistrar() {
    ...
    // console.log(this.form.value['medico'] === null);
    return (this.form.value['medico'] === null || this.form.value['paciente'] === null ||
            this.detalleConsulta.length === 0  || this.especialidadSeleccionada === null) ? true : false;
  }
